...
class VCRR2CGloVeAdv(ModelBase):
  """Wraps the BiLSTM layer to solve the VCR task."""

  def __init__(self, model_proto, is_training):
    super(VCRR2CGloVeAdv, self).__init__(model_proto, is_training)

    if not isinstance(model_proto, model_pb2.VCRR2CGloVeAdv):
      raise ValueError('Options has to be an VCRR2CGloVeAdv proto.')
