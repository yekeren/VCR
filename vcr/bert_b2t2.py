...
class BertB2T2(ModelBase):
  """Wraps the BiLSTM layer to solve the VCR task."""

  def __init__(self, model_proto, is_training):
    super(BertB2T2, self).__init__(model_proto, is_training)

    if not isinstance(model_proto, model_pb2.BertB2T2):
      raise ValueError('Options has to be an BertB2T2 proto.')
